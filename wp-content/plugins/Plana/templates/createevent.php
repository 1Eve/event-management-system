...
<div
    ...
    <form method="post"
        ...
        <div class="form-outline">
            ...
            <textarea class="form-control" rows="4" type="text" style="width:100%;" placeholder="Enter event details" name="event_desc" required></textarea>
        </div>

        <div>
            <label>Organizer Information </label><br>
            <input type="text" style="width:100%;" placeholder="Enter event organizer's information" name="organizer_info" required><br>
